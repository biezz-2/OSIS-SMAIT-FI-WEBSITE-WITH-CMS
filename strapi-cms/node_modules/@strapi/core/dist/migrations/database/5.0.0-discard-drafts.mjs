 ...
 */ const assignMissingOrderColumnFromFallback = (relations, { orderColumn, fallbackOrderColumn, groupByColumn, tieBreakerColumn })=>{
 ...
 */ async function getExistingRelationKeys({ trx, joinTable, sourceColumnName, targetColumnName, filterIds, filterColumnName }) {
 ...
 */ async function copyRelationsToOtherContentTypes({ trx, uid, publishedToDraftMap }) {
    ...
    for (const [attributeName, attribute] of Object.entries(meta.attributes)){
        ...
        for (const publishedIdsChunk of publishedIdsChunks){
            ...
            if (relationsToInsert.length > 0) {
                assignMissingOrderColumnFromFallback(relationsToInsert, {
