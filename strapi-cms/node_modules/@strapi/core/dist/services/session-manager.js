...
class SessionManager {
   ...
   */ get cleanupThreshold() {
    ...
    async generateRefreshToken(userId, deviceId, origin, options) {
        ...
        const token = jwt__default.default.sign(payload, jwtKey, {
            algorithm,
            noTimestamp: true,
            ...jwtSignOptions
        });
    ...
    validateAccessToken(token, origin) {
        ...
        try {
            ...
            const payload = jwt__default.default.verify(token, jwtKey, {
                algorithms: [
                    algorithm
                ],
                ...config.jwtOptions
    ...
    async validateRefreshToken(token, origin) {
        ...
        try {
            ...
            const payload = jwt__default.default.verify(token, jwtKey, verifyOptions);
    ...
    async rotateRefreshToken(refreshToken, origin) {
        ...
        try {
            ...
            const algorithm = config.algorithm || constants.DEFAULT_ALGORITHM;
            const jwtKey = this.getJwtKey(config, algorithm, 'verify');
            const payload = jwt__default.default.verify(refreshToken, jwtKey, {
                algorithms: [
                    algorithm
                ],
                ...config.jwtOptions
            ...
            if (current.childId) {
                ...
                if (child) {
                    ...
                    const childToken = jwt__default.default.sign(childPayload, jwtKey, {
                        algorithm,
                        noTimestamp: true,
                        ...jwtSignOptions
                    });
            ...
            // Filter out conflicting options that are already handled by the payload
            const { expiresIn, ...jwtSignOptions } = config.jwtOptions || {};
            const childToken = jwt__default.default.sign(payloadOut, jwtKey, {
                algorithm,
                noTimestamp: true,
                ...jwtSignOptions
            });
