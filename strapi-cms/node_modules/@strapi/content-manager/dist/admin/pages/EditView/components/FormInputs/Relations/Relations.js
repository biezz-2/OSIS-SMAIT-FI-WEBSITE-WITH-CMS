 ...
 */ const RelationsField = /*#__PURE__*/ React__namespace.forwardRef(({ disabled, label, ...props }, ref)=>{
    ...
    const onChangeRelationField = field.onChange;
     ...
     */ const relations$2 = React__namespace.useMemo(()=>{
        ...
        /**
       * Tidy up our data.
       */ const transformations = pipe__default.default(removeConnected(ctx), removeDisconnected(ctx), addLabelAndHref(ctx));
    ...
    const handleConnect = React__namespace.useCallback((relation)=>{
        ...
        if (ONE_WAY_RELATIONS.includes(props.attribute.relation)) {
            ...
            onChangeRelationField(`${props.name}.connect`, [
                item
            ]);
        } else {
            onChangeRelationField(`${props.name}.connect`, [
