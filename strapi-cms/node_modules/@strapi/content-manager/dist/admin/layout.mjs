...
import 'react';
import { useIsMobile, Page, SubNav, Layouts, LazyOutlet } from '@strapi/admin/strapi-admin';
   ...
   */ const [actualType] = type.split('_');
    switch(actualType){
        ...
        case ItemTypes.FIELD:
            return isCardDragItem(item) ? /*#__PURE__*/ jsx(CardDragPreview, {
                label: item.label
            }) : null;
        case ItemTypes.COMPONENT:
        case ItemTypes.DYNAMIC_ZONE:
            return isComponentDragItem(item) ? /*#__PURE__*/ jsx(ComponentDragPreview, {
                displayedValue: item.displayedValue
            }) : null;
        case ItemTypes.RELATION:
            return isRelationDragItem(item) ? /*#__PURE__*/ jsx(RelationDragPreview, {
                ...item
            }) : null;
        default:
            return null;
