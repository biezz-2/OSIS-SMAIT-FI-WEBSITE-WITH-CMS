...
var en = {
    ...
    "containers.EditView.publishHint": "Ctrl / Cmd + Shift + Enter to publish",
    "containers.EditView.saveHint": "Ctrl / Cmd + Enter to save",
    ...
    "popUpWarning.warning.has-draft-relations.message": "This entry is related to {count, plural, one {# draft entry} other {# draft entries}}. {count, plural, one {That relation will not be included in the published version.} other {Those relations will not be included in the published version.}}",
    "popUpWarning.warning.has-draft-m2m-relations.message": "{count, plural, one {# linked entry is still in draft. It will appear on the live site once that entry is published.} other {# linked entries are still in draft. They will appear on the live site once those entries are published.}}",
    "popUpWarning.warning.has-draft-m2m-relations.additional": "{count, plural, one {# many-to-many link points} other {# many-to-many links point}} to draft entries that will become visible once published.",
    "popUpwarning.warning.has-draft-relations.button-confirm": "Publish without relations",
