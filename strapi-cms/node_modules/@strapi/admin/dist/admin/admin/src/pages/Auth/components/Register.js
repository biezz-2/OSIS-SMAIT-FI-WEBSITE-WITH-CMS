...
const isMessageDescriptor = (value)=>{
    return isRecord(value) && typeof value.id === 'string' && typeof value.defaultMessage === 'string';
};
                    ...
                    onSubmit: async (data, helpers)=>{
                        ...
                        try {
                            ...
                            if (normalizedData.registrationToken) {
                                ...
                                await handleRegisterAdmin(omit__default.default(normalizedData, [
                                    'registrationToken',
                                    'confirmPassword'
                                ]), helpers.setErrors);
                            }
