...
import { hasLocaleValidationErrors } from '../utils/localePermissionValidation.mjs';
...
const Permissions = /*#__PURE__*/ React.forwardRef(({ layout, isFormDisabled, onLocaleValidationChange, permissions = [], userPermissions }, api)=>{
    ...
    React.useImperativeHandle(api, ()=>{
        return {
            getPermissions () {
                ...
                const permissionsToSend = formatPermissionsForAPI(modifiedData).map((perm)=>restoreNullLocalesIfUnchanged(perm, permissions, initialData, modifiedData));
                return {
                    permissionsToSend,
                    didUpdateConditions
                };
