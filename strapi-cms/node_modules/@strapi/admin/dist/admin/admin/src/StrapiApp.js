...
class StrapiApp {
   ...
   */ async loadTrads(customTranslations = {}) {
        ...
        const localesForPlugins = uniq__default.default(this.configurations.locales.flatMap((locale)=>{
    ...
    render() {
        const localeNames = pick__default.default(languageNativeNames.languageNativeNames, this.configurations.locales || []);
        ...
        this.store = configure.configureStore({
            admin_app: {
                permissions: merge__default.default({}, constants$1.ADMIN_PERMISSIONS_CE, constants.ADMIN_PERMISSIONS_EE),
                theme: {
                    availableThemes: [],
   ...
   */ this.addSettingsLink = (sectionId, link)=>{
        ...
        this.createCustomConfigurations = (customConfig)=>{
            if (customConfig.locales) {
                ...
                this.configurations.locales = uniq__default.default([
                    'en',
                    ...extraLocales
                ]);
            }
            ...
            if (customConfig.theme) {
                ...
                if (lightTheme) merge__default.default(this.configurations.themes.light, lightTheme);
                if (darkTheme) merge__default.default(this.configurations.themes.dark, darkTheme);
            }
        ...
        this.registerHook = (name, fn)=>{
            invariant__default.default(this.hooksDict[name], `The hook ${name} is not defined. You are trying to register a hook that does not exist in the application.`);
