 ...
 */ const useTracking = ()=>{
    ...
    const deviceTypeRef = React__namespace.useRef(deviceType);
    ...
    const trackUsage = React__namespace.useCallback(async (event, properties)=>{
        try {
            if (uuid && !window.strapi.telemetryDisabled) {
                const res = await axios__default.default.post(`${process.env.STRAPI_ANALYTICS_URL || 'https://analytics.strapi.io'}/api/v2/track`, {
                    event,
                    userId,
                    eventProperties: {
                        ...properties
