...
const server = setupServer(...[
    ...
    http.get('/admin/users/me/sessions', ()=>HttpResponse.json({
            data: [
                {
                    id: 'session-current',
    ...
    http.delete('/admin/users/me/sessions/:sessionId', ()=>HttpResponse.json({
            data: {}
        })),
    http.delete('/admin/users/me/sessions', ()=>HttpResponse.json({
            data: {}
        })),
    /**
     *
