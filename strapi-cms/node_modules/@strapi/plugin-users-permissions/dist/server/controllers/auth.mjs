...
import { __require as requireRefreshCookieOptions } from '../utils/refresh-cookie-options.mjs';
import { __require as requireAuth$1 } from './validation/auth.mjs';
import { __require as requireOauthConnect } from '../utils/oauth-connect/index.mjs';
...
function requireAuth() {
    ...
    const { buildRefreshCookieOptions } = requireRefreshCookieOptions();
    ...
    auth = ({ strapi: strapi1 })=>({
            ...
            async connect (ctx, next) {
                ...
                const { createOAuthConnectMiddleware } = requireOauthConnect();
