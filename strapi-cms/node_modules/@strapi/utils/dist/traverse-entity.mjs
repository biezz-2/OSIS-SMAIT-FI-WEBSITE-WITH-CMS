...
const traverseEntity$1 = async (visitor, options, entity)=>{
    const { path = {
        raw: null,
        attribute: null,
        rawWithIndices: null
    ...
    const traverseMorphRelationTarget = async (visitor, path, entry)=>{
        ...
        return traverseEntity$1(visitor, traverseOptions, entry);
    };
...
var traverseEntity = curry(traverseEntity$1);

export { traverseEntity as default };
