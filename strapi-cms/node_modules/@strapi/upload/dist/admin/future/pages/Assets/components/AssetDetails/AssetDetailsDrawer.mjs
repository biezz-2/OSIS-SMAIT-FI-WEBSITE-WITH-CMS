...
import { useQueryParams, useNotification, Form, Blocker, getDisplayName, useForm, useField, useClipboard } from '@strapi/admin/strapi-admin';
import { VisuallyHidden, Flex, Loader, Alert, Typography, Box, Button, IconButton, Field, TextInput, Tooltip, SingleSelect, SingleSelectOption, Dialog } from '@strapi/design-system';
...
const AssetImageActions = ({ onCrop })=>{
    ...
    return /*#__PURE__*/ jsxs(Flex, {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx(ReplaceAssetButton, {})
        ]
    });
};
                    ...
                    children: ({ modified, isSubmitting, values, resetForm })=>{
                        ...
                        return /*#__PURE__*/ jsxs(Fragment, {
                            children: [
                                ...
                                busyMessage ? /*#__PURE__*/ jsx(DrawerBusyOverlay, {
                                ...
                                /*#__PURE__*/ jsxs(Drawer.ScrollableContent, {
                                    children: [
                                        /*#__PURE__*/ jsx(AssetPreview, {
                                            asset: asset,
                                            actions: isImage ? /*#__PURE__*/ jsx(AssetImageActions, {
