...
var AssetCropEditor = require('./AssetCropEditor.js');
...
const DetailItemContainer = styledComponents.styled(designSystem.Flex)`
  flex: 0 0 calc(50% - ${({ theme })=>theme.spaces[2]});
`;
const DetailItem = ({ label, value })=>/*#__PURE__*/ jsxRuntime.jsxs(DetailItemContainer, {
        direction: "column",
 ...
 */ const getBusyMessage = (state)=>{
    if (state.isDeleting) {
        return {
            id: translations.getTranslationKey('asset-details.delete.loading'),
            defaultMessage: 'Deleting the file…'
        };
    }
    if (state.isCropCopying) {
        return {
            id: translations.getTranslationKey('asset-details.crop.loading'),
            defaultMessage: 'Saving the cropped copy…'
        };
    }
    if (state.isReplacing) {
        return {
            id: translations.getTranslationKey('asset-details.replace.loading'),
...
const AssetImageActions = ({ onCrop })=>{
    const { formatMessage } = reactIntl.useIntl();
    const isSubmitting = strapiAdmin.useForm('AssetImageActions', (state)=>state.isSubmitting);
    return /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
            /*#__PURE__*/ jsxRuntime.jsx(designSystem.IconButton, {
                withTooltip: false,
                label: formatMessage({
                    id: translations.getTranslationKey('asset-details.crop.trigger'),
                    defaultMessage: 'Crop'
                }),
                variant: "tertiary",
                onClick: onCrop,
            ...
            /*#__PURE__*/ jsxRuntime.jsx(ReplaceAssetButton, {})
        ]
    });
};
const AssetDetails = ({ asset, closeDetails })=>{
    ...
    const [uploadCroppedCopy, { isLoading: isCropCopying }] = api.useUploadFileSilentlyMutation();
    const [isCropOpen, setIsCropOpen] = React__namespace.useState(false);
    ...
    const isImage = asset.mime?.includes(enums.ASSET_TYPES.Image);
    const initialValues = {
        name: asset.name ?? '',
    ...
    const notifyCropError = ()=>{
        notify({
            type: 'danger',
            message: formatMessage({
                id: translations.getTranslationKey('asset-details.crop.error'),
    ...
    const handleCropApply = async (file, focalPoint)=>{
        ...
        notify({
            type: 'success',
            message: formatMessage({
                id: translations.getTranslationKey('asset-details.crop.success'),
    ...
    const handleCropSaveAsCopy = async (file, focalPoint)=>{
        ...
        notify({
            type: 'success',
            message: formatMessage({
                id: translations.getTranslationKey('asset-details.crop.copy-success'),
                    ...
                    children: ({ modified, isSubmitting, values, resetForm })=>{
                        ...
                        return /*#__PURE__*/ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                            children: [
                                ...
                                isCropOpen && isImage ? /*#__PURE__*/ jsxRuntime.jsx(AssetCropEditor.AssetCropEditor, {
                                    asset: asset,
                                    onClose: ()=>setIsCropOpen(false),
                                    onApply: handleCropApply,
                                    onSaveAsCopy: handleCropSaveAsCopy
                                }) : null,
                                busyMessage ? /*#__PURE__*/ jsxRuntime.jsx(DrawerBusyOverlay, {
                                ...
                                /*#__PURE__*/ jsxRuntime.jsxs(Drawer.Drawer.ScrollableContent, {
                                    children: [
                                        /*#__PURE__*/ jsxRuntime.jsx(AssetPreview.AssetPreview, {
                                            asset: asset,
                                            actions: isImage ? /*#__PURE__*/ jsxRuntime.jsx(AssetImageActions, {
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
            ...
            /*#__PURE__*/ jsxRuntime.jsx(designSystem.Box, {
                marginLeft: "auto",
                children: /*#__PURE__*/ jsxRuntime.jsx(Drawer.Drawer.CloseButton, {
                    onClose: closeDetails,
                    children: /*#__PURE__*/ jsxRuntime.jsx(icons.ArrowLineRight, {})
                })
            })
        ]
    });
...
const DrawerContent = ({ assetId, closeDetails })=>{
    const { formatMessage } = reactIntl.useIntl();
    const { data: asset, isLoading, error } = assets.useGetAssetQuery(assetId, {
    ...
    if (error || !asset) {
        return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Flex, {
            ...
            children: /*#__PURE__*/ jsxRuntime.jsx(designSystem.Alert, {
                ...
                onClose: closeDetails,
                children: formatMessage({
                    id: translations.getTranslationKey('asset-details.error'),
 ...
 * -----------------------------------------------------------------------------------------------*/ const AssetDetailsDrawer = ()=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(Drawer.Drawer.Root, {
        isVisible: isVisible,
        onClose: closeDetails,
        children: [
            /*#__PURE__*/ jsxRuntime.jsx("div", {
                children: /*#__PURE__*/ jsxRuntime.jsxs(designSystem.VisuallyHidden, {
                    children: [
                        /*#__PURE__*/ jsxRuntime.jsx(Drawer.Drawer.Title, {
                            children: formatMessage({
                                id: translations.getTranslationKey('asset-details.title'),
                                defaultMessage: 'File details'
                            })
                        }),
                        /*#__PURE__*/ jsxRuntime.jsx(Drawer.Drawer.Description, {
                            children: formatMessage({
                                id: translations.getTranslationKey('asset-details.description'),
            ...
            /*#__PURE__*/ jsxRuntime.jsx(Drawer.Drawer.Body, {
