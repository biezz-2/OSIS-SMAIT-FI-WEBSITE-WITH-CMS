    ...
    endpoints: (builder)=>({
       ...
       */ uploadFileSilently: builder.mutation({
                queryFn: async ({ file, fileInfo }, { getState })=>{
                    ...
                    try {
                        const uploaded = await uploadFileViaXHR.uploadFileViaXHR(url, token, formData, new AbortController().signal, ()=>{});
                        return {
                            data: uploaded
                        };
                    } catch (err) {
       ...
       */ uploadFromUrls: builder.mutation({
                queryFn: async ({ urls, folderId }, { dispatch, getState })=>{
                    ...
                    const fileNames = urls.map((url)=>files.getFilenameFromUrl(url));
...
exports.useUploadFileSilentlyMutation = useUploadFileSilentlyMutation;
