...
declare const _default: () => {
    ...
    controllers: {
        'admin-file': {
            ...
            getAIMetadataCount(ctx: import("koa").Context): Promise<any>;
            generateAIMetadata(ctx: import("koa").Context): Promise<any>;
            getLatestAIMetadataJob(ctx: import("koa").Context): Promise<any>;
        };
        'admin-folder': {
        ...
        'admin-settings': {
            ...
            getSettings(ctx: import("koa").Context): Promise<any>;
        };
        'admin-upload': {
            ...
            uploadFiles(ctx: import("koa").Context): Promise<any>;
            unstable_uploadFile(ctx: import("koa").Context): Promise<any>;
            unstable_uploadFromUrls(ctx: import("koa").Context): Promise<any>;
        ...
        'content-api': ({ strapi }: {
            ...
            findOne(ctx: import("koa").Context): Promise<any>;
            destroy(ctx: import("koa").Context): Promise<any>;
            updateFileInfo(ctx: import("koa").Context): Promise<void>;
            replaceFile(ctx: import("koa").Context): Promise<void>;
        ...
        'view-configuration': {
            updateViewConfiguration(ctx: import("koa").Context): Promise<any>;
    ...
    services: {
        ...
        upload: ({ strapi }: {
            ...
            setSettings: (value: import("./controllers/validation/admin/settings").Settings) => Promise<void>;
            ...
            setConfiguration: (value: import("./controllers/validation/admin/configureView").ViewConfiguration) => Promise<void>;
        ...
        aiMetadata: ({ strapi }: {
            ...
            updateFilesWithAIMetadata(files: import("./types").File[], metadataResults: Array<{
                altText: string;
                caption: string;
            } | null>, user: {
                id: string | number;
            ...
            processFiles(files: import("./types").File[]): Promise<Array<{
                altText: string;
                caption: string;
            } | null>>;
        };
