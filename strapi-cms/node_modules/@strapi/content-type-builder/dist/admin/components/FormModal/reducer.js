...
var customFieldDefaultOptionsReducer = require('./utils/customFieldDefaultOptionsReducer.js');
    ...
    reducers: {
        ...
        onChangeRelationTarget: (state, action)=>{
            ...
            if (Array.isArray(targetContentTypeAllowedRelations)) {
                const currentRelationType = getRelationType.getRelationType(modifiedData.relation, modifiedData.targetAttribute);
            ...
            if (didChangeRelationTypeBecauseOfRestrictedRelation && changedRelationType !== null) {
                nameToSet = pluralize__default.default(snakeCase__default.default(nameToSlug.nameToSlug(selectedContentTypeFriendlyName)), relations.shouldPluralizeName(changedRelationType));
            } else {
                nameToSet = pluralize__default.default(snakeCase__default.default(nameToSlug.nameToSlug(selectedContentTypeFriendlyName)), relations.shouldPluralizeName(modifiedData.relation));
            }
            set__default.default(state, [
                'modifiedData',
                'name'
            ...
            const targetAttributeToSet = pluralize__default.default(snakeCase__default.default(nameToSlug.nameToSlug(oneThatIsCreatingARelationWithAnother)), relations.shouldPluralizeTargetAttribute(modifiedData.relation));
            set__default.default(state, [
                'modifiedData',
                'targetAttribute'
        ...
        onChangeRelationType: (state, action)=>{
            ...
            if (![
                ...
                set__default.default(state, [
                    'modifiedData',
                    'name'
                ], pluralize__default.default(snakeCase__default.default(nameToSlug.nameToSlug(currentName)), relations.shouldPluralizeName(value)));
                set__default.default(state, [
                    'modifiedData',
                    'targetAttribute'
                ], pluralize__default.default(currentTargetAttribute || snakeCase__default.default(nameToSlug.nameToSlug(oneThatIsCreatingARelationWithAnother)), relations.shouldPluralizeTargetAttribute(value)));
                return;
            }
            if (value === 'oneWay') {
                set__default.default(state, [
                ...
                set__default.default(state, [
                    'modifiedData',
                    'name'
                ], pluralize__default.default(snakeCase__default.default(currentName), 1));
                return;
            }
            // manyWay
            set__default.default(state, [
            ...
            set__default.default(state, [
                'modifiedData',
                'name'
            ], pluralize__default.default(snakeCase__default.default(currentName), 2));
        },
        resetProps: ()=>{
            return initialState;
        },
        ...
        resetPropsAndSaveCurrentData: (state, action)=>{
            ...
            if (componentToCreate?.displayName === undefined || componentToCreate.category === undefined) {
                return initialState;
            }
            const modifiedData = {
                ...
                repeatable: false,
                ...options,
                component: createUid.createComponentUid(componentToCreate.displayName, componentToCreate.category)
            };
            return {
                ...initialState,
                componentToCreate,
        ...
        setCustomFieldDataSchema: (state, action)=>{
            ...
            const optionDefaults = allOptions.reduce(customFieldDefaultOptionsReducer.customFieldDefaultOptionsReducer, []);
            if (optionDefaults.length) {
                optionDefaults.forEach(({ name, defaultValue })=>set__default.default(state.modifiedData, name, defaultValue));
            }
        },
