...
const updateType = (type, data)=>{
    merge__default.default(type, data);
    setStatus(type, 'CHANGED');
};
const slice = undoRedo.createUndoRedoSlice({
    ...
    reducers: {
        ...
        addAttribute: (state, action)=>{
            ...
            const attribute = createAttribute(omit__default.default(attributeToSet, 'createComponent'));
            if (attribute.type === 'relation') {
                ...
                const isBidirectionalRelation = relationType !== undefined && ![
                    'oneWay',
                    'manyWay'
        ...
        editAttribute: (state, action)=>{
            ...
            const isBidirectionnal = newRelationType !== undefined && !ONE_SIDE_RELATIONS.includes(newRelationType);
            if (isBidirectionnal) {
