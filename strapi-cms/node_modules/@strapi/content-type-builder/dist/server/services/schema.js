...
const getSchema = async ()=>{
    const contentTypes$1 = fp.mapValues((contentType)=>{
        ...
        return {
            ...
            visible: contentTypes.isContentTypeVisible(contentType),
            restrictRelationsTo: contentTypes.getRestrictRelationsTo(contentType)
        };
    }, strapi.contentTypes);
    const components = fp.mapValues((component)=>{
...
const updateSchema = async (schema)=>{
    const builder = index();
    const apiHandler = index$1.getService('api-handler');
