...
export declare const isRelation: (attribute: Schema.Attribute.AnyAttribute) => attribute is Schema.Attribute.Relation<Schema.Attribute.RelationKind.Any, import("@strapi/types/dist/uid/index.js").ContentType>;
/**
