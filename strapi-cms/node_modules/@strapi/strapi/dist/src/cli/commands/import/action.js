 ...
 */ var action = (async (opts)=>{
    ...
    const source = (await fse__default.default.stat(backupPath)).isDirectory() ? dataTransfer.directory.providers.createLocalDirectorySourceProvider({
        directory: {
            path: backupPath
        }
   ...
   */ const strapiInstance = await dataTransfer$1.createStrapiInstance();
    dataTransfer$1.validateContentTypeTransferOptionsForStrapi(opts, strapiInstance);
    /**
   ...
   */ const engineOptions = {
    ...
    const destinationOptions = {
        ...
        restore: dataTransfer$1.parseRestoreFromOptions(opts, strapiInstance)
    };
