 ...
 *
 * @internal
 */ const ADMIN_VITE_ALIAS_MODULES = [
    'react',
    'react-dom',
    'react-router-dom',
    'styled-components',
 ...
 */ const ADMIN_VITE_DEDUPE_MODULES = [
    ...ADMIN_VITE_ALIAS_MODULES,
    ...ADMIN_VITE_SINGLETON_MODULES
];

export { ADMIN_VITE_ALIAS_MODULES, ADMIN_VITE_DEDUPE_MODULES, ADMIN_VITE_SINGLETON_MODULES };
//# sourceMappingURL=admin-vite-alias-modules.mjs.map
