...
const reactFlowSmartEdge = require("@tisoap/react-flow-smart-edge");
...
const dagre__default = /* @__PURE__ */ _interopDefault(dagre);
...
function getIcon(attrType) {
  switch (attrType.toLowerCase()) {
    case "string":
    case "text":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.TextField, {});
    case "email":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.EmailField, {});
    case "enumeration":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.EnumerationField, {});
    case "password":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.PasswordField, {});
    case "boolean":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.BooleanField, {});
    case "relation":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.RelationField, {});
    case "datetime":
    case "date":
    case "time":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.DateField, {});
    case "integer":
    case "decimal":
    case "biginteger":
    case "float":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.NumberField, {});
    case "json":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.JsonField, {});
    case "uid":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.UidField, {});
    case "richtext":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.TextField, {});
    case "media":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.MediaField, {});
    case "blocks":
      return /* @__PURE__ */ jsxRuntime.jsx(symbols.BlocksField, {});
    case "onetomany":
      return /* @__PURE__ */ jsxRuntime.jsx(icons.OneToMany, {});
    case "oneway":
      return /* @__PURE__ */ jsxRuntime.jsx(icons.OneWay, {});
    case "onetoone":
      return /* @__PURE__ */ jsxRuntime.jsx(icons.OneToOne, {});
    case "manytomany":
      return /* @__PURE__ */ jsxRuntime.jsx(icons.ManyToMany, {});
    case "manytoone":
      return /* @__PURE__ */ jsxRuntime.jsx(icons.ManyToOne, {});
    case "manyways":
    case "morphtomany":
      return /* @__PURE__ */ jsxRuntime.jsx(icons.ManyWays, {});
    default:
      return null;
  }
}
...
const useDigramStore = zustand.create()(
  middleware.persist(
    (set2, get2) => ({
      nodes: [],
      edges: [],
      ...
      toggleOption: (optionName, optionValue = null) => {
        const newOptions = { ...get2().options };
        if (optionValue !== null) {
          newOptions[optionName] = optionValue;
        } else {
          newOptions[optionName] = !newOptions[optionName];
        }
        set2({ options: newOptions });
      },
      onNodesChange: (changes) => {
        set2({
          nodes: reactflow.applyNodeChanges(changes, get2().nodes)
        });
      },
      onEdgesChange: (changes) => {
        set2({
          edges: reactflow.applyEdgeChanges(changes, get2().edges)
        });
      },
      onConnect: (connection) => {
        set2({
          edges: reactflow.addEdge(connection, get2().edges)
        });
      },
      drawDiagram: () => {
        const options = get2().options;
        let typesToDraw = get2().data;
        ...
        setTimeout(() => get2().applyLayout(), 10);
      },
      redrawNodes: () => {
        let newNodes = updateNodes(get2().nodes, get2().options);
        set2({
          nodes: newNodes
        });
      },
      redrawEdges: () => {
        let newEdges = updateEdges(get2().edges, get2().options);
        set2({
          edges: newEdges
        });
      },
...
function RelationIcon({ theme, children }) {
...
const CustomNode = React__namespace.default.memo(({ data }) => {
  const theme = styledComponents.useTheme();
  const attributesToShow = React.useMemo(
  ...
  const dividerStyle = React.useMemo(() => ({ margin: "8px 0" }), []);
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
    /* @__PURE__ */ jsxRuntime.jsx("style", { children: `
					.cte-plugin-box {
            position: relative;
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(
      designSystem.Box,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Divider, { style: dividerStyle }),
          attributesToShow.map((attr) => {
            return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { children: /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "cte-plugin-field", children: [
              /* @__PURE__ */ jsxRuntime.jsx("p", { className: "cte-plugin-line nodrag", children: attr[0] }),
              /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [
                data.options.showTypes && /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.Badge,
                  {
                    size: "M",
                ...
                attr[1].type === "relation" && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tooltip, { description: attr[1].relation, children: /* @__PURE__ */ jsxRuntime.jsx(RelationIcon, { theme, children: getIcon(attr[1].relation ?? "") }) }),
                  /* @__PURE__ */ jsxRuntime.jsx(
                    reactflow.Handle,
                    {
                      type: "source",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(
          designSystem.SingleSelect,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "smartbezier", children: "Smart Bezier" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "smartstraight", children: "Smart Straight" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "smartstep", children: "Smart Step" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "default", children: "Bezier" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "simplebezier", children: "Simple Bezier" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "straight", children: "Straight" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "step", children: "Step" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "smoothstep", children: "Smooth Step" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsxs(
          designSystem.SingleSelect,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "dots", children: "Dots" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "lines", children: "Lines" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "cross", children: "Cross" }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "none", children: "None" })
            ]
          }
        )
      ]
...
function ExportModal({ imageRef }) {
  ...
  const [quality, setQuality] = React.useState(0.95);
  ...
  const exportDiagram = React.useCallback(() => {
    ...
    setTimeout(() => {
      ...
      if (format == "png") {
        ...
        htmlToImage.toSvg(imageRef.current, {
          cacheBust: true,
          filter,
          style: {
            background: theme.colors?.neutral100
        ...
        htmlToImage.toJpeg(imageRef.current, {
          cacheBust: true,
          filter,
          quality,
          style: {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Content, { children: [
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Header, { children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Title, { children: "Export Diagram" }) }),
    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Body, { children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: "Format" }),
      /* @__PURE__ */ jsxRuntime.jsxs(
        designSystem.SingleSelect,
        {
          onClear: () => {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "svg", children: "SVG" }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "png", children: "PNG" }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelectOption, { value: "jpeg", children: "JPEG" })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntime.jsx("span", { style: { height: "16px", display: "block" } }),
      format == "jpeg" && /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field.Label, { children: "Quality" }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", textColor: "neutral600", children: "0.0 - 1.0" }),
        /* @__PURE__ */ jsxRuntime.jsx(
    ...
    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Modal.Footer, { children: /* @__PURE__ */ jsxRuntime.jsx(
      designSystem.Button,
      {
        ...
        startIcon: isExporting ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Loader, { small: true }) : void 0,
...
const applyDagreLayout = (nodes, edges, direction, usePositionCache = true) => {
  const positionCache = /* @__PURE__ */ new Map();
  const nodesToLayout = [...nodes];
  const g2 = new dagre__default.default.graphlib.Graph();
  g2.setGraph({
    rankdir: direction,
    nodesep: 80,
    ranksep: 120,
  ...
  dagre__default.default.layout(g2);
  const layoutedNodes = nodesToLayout.map((node) => {
    ...
    if (nodeWithPosition && !isNaN(nodeWithPosition.x) && !isNaN(nodeWithPosition.y)) {
      ...
      return {
        ...
        targetPosition: isHorizontal ? reactflow.Position.Left : reactflow.Position.Top,
        sourcePosition: isHorizontal ? reactflow.Position.Right : reactflow.Position.Bottom,
...
const useEffectSkipInitial = (func2, deps) => {
...
const HomePage = React__namespace.default.memo(() => {
  const theme = styledComponents.useTheme();
  const { get: get2 } = admin$1.useFetchClient();
  ...
  const nodeTypes = React.useMemo(() => ({ special: CustomNode }), []);
  const edgeTypes = React.useMemo(
    () => ({
      smartbezier: reactFlowSmartEdge.SmartBezierEdge,
      smartstep: reactFlowSmartEdge.SmartStepEdge,
      smartstraight: reactFlowSmartEdge.SmartStraightEdge
    }),
    []
  );
  const regenrate = React.useCallback(async () => {
    const { data } = await get2(`/schema-visualizer/get-types`);
    setData2(data);
    drawDiagram();
  }, [get2, setData2, drawDiagram]);
  ...
  const debouncedLayout = React.useCallback(
    debounce((direction) => {
      onLayout(direction);
    }, 250),
    [onLayout]
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100vh" }, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      Layouts.Header,
      {
        title: "Schema Visualizer",
        primaryAction: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Root, { children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(ExportModal, { imageRef: ref2 })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntime.jsx("style", { children: `
          ...
          .cte-plugin-controls button svg {
            fill: var(--button-foreground);
				...
				` }),
    /* @__PURE__ */ jsxRuntime.jsx(OptionsBar, {}),
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ref: ref2,
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(
          reactflow.ReactFlow,
          {
            ...flowProps,
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(reactflow.Panel, { position: "top-right", style: { display: "flex", gap: "10px" }, children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.Button,
                  {
                    onClick: () => onLayout("TB"),
                ...
                reactflow.Controls,
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(
                    reactflow.ControlButton,
                    {
                      ...
                      children: options.scrollMode ? /* @__PURE__ */ jsxRuntime.jsx(icons.Drag, { fill: "#000000" }) : /* @__PURE__ */ jsxRuntime.jsx(icons.Search, { fill: "#000000" })
                    }
                  )
                }
              ),
