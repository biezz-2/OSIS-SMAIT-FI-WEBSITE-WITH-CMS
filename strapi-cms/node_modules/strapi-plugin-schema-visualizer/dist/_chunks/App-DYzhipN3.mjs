...
import { Alert, Typography, Box, useCallbackRef, Flex, Field, Divider, Badge, Tooltip, Checkbox, SingleSelect, SingleSelectOption, Modal, NumberInput, Button, Loader, DesignSystemProvider, darkTheme } from "@strapi/design-system";
...
import { WarningCircle, CaretDown, ManyWays, ManyToOne, ManyToMany, OneToOne, OneWay, OneToMany, ArrowClockwise, Download, Drag, Search } from "@strapi/icons";
import { BlocksField, MediaField, TextField, UidField, JsonField, NumberField, DateField, RelationField, BooleanField, PasswordField, EnumerationField, EmailField } from "@strapi/icons/symbols";
import "react-intl";
import { createGlobalStyle, styled, useTheme } from "styled-components";
import { SmartStraightEdge, SmartStepEdge, SmartBezierEdge } from "@tisoap/react-flow-smart-edge";
import { addEdge, applyEdgeChanges, applyNodeChanges, Handle, Position, ReactFlow, Panel, Controls, ControlButton, Background } from "reactflow";
...
function getIcon(attrType) {
  switch (attrType.toLowerCase()) {
    ...
    case "email":
      return /* @__PURE__ */ jsx(EmailField, {});
    case "enumeration":
      return /* @__PURE__ */ jsx(EnumerationField, {});
    case "password":
      return /* @__PURE__ */ jsx(PasswordField, {});
    case "boolean":
      return /* @__PURE__ */ jsx(BooleanField, {});
    case "relation":
    ...
    case "json":
      return /* @__PURE__ */ jsx(JsonField, {});
    case "uid":
      return /* @__PURE__ */ jsx(UidField, {});
    case "richtext":
      return /* @__PURE__ */ jsx(TextField, {});
    case "media":
      return /* @__PURE__ */ jsx(MediaField, {});
    case "blocks":
      return /* @__PURE__ */ jsx(BlocksField, {});
    case "onetomany":
      return /* @__PURE__ */ jsx(OneToMany, {});
    case "oneway":
      return /* @__PURE__ */ jsx(OneWay, {});
    case "onetoone":
      return /* @__PURE__ */ jsx(OneToOne, {});
    case "manytomany":
      return /* @__PURE__ */ jsx(ManyToMany, {});
    case "manytoone":
      return /* @__PURE__ */ jsx(ManyToOne, {});
    case "manyways":
    case "morphtomany":
      return /* @__PURE__ */ jsx(ManyWays, {});
    default:
      return null;
  }
}
  ...
  persist(
    (set2, get2) => ({
      ...
      onNodesChange: (changes) => {
        set2({
          nodes: applyNodeChanges(changes, get2().nodes)
        });
      },
      onEdgesChange: (changes) => {
        set2({
          edges: applyEdgeChanges(changes, get2().edges)
        });
      },
      onConnect: (connection) => {
        set2({
          edges: addEdge(connection, get2().edges)
        });
      },
      drawDiagram: () => {
...
const CustomNode = React__default.memo(({ data }) => {
    ...
    /* @__PURE__ */ jsxs(
      Box,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Divider, { style: dividerStyle }),
          attributesToShow.map((attr) => {
            return /* @__PURE__ */ jsx(Typography, { children: /* @__PURE__ */ jsxs("div", { className: "cte-plugin-field", children: [
              /* @__PURE__ */ jsx("p", { className: "cte-plugin-line nodrag", children: attr[0] }),
              /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center" }, children: [
                data.options.showTypes && /* @__PURE__ */ jsx(
                  Badge,
                  {
                    size: "M",
                ...
                attr[1].type === "relation" && /* @__PURE__ */ jsxs(Fragment, { children: [
                  /* @__PURE__ */ jsx(Tooltip, { description: attr[1].relation, children: /* @__PURE__ */ jsx(RelationIcon, { theme, children: getIcon(attr[1].relation ?? "") }) }),
                  /* @__PURE__ */ jsx(
                    Handle,
                    {
                      type: "source",
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(
          SingleSelect,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "smartbezier", children: "Smart Bezier" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "smartstraight", children: "Smart Straight" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "smartstep", children: "Smart Step" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "default", children: "Bezier" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "simplebezier", children: "Simple Bezier" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "straight", children: "Straight" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "step", children: "Step" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "smoothstep", children: "Smooth Step" })
            ]
          }
        ),
        /* @__PURE__ */ jsxs(
          SingleSelect,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "dots", children: "Dots" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "lines", children: "Lines" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "cross", children: "Cross" }),
              /* @__PURE__ */ jsx(SingleSelectOption, { value: "none", children: "None" })
            ]
          }
        )
      ]
...
function ExportModal({ imageRef }) {
  ...
  return /* @__PURE__ */ jsxs(Modal.Content, { children: [
    /* @__PURE__ */ jsx(Modal.Header, { children: /* @__PURE__ */ jsx(Modal.Title, { children: "Export Diagram" }) }),
    /* @__PURE__ */ jsxs(Modal.Body, { children: [
      ...
      /* @__PURE__ */ jsxs(
        SingleSelect,
        {
          ...
          children: [
            /* @__PURE__ */ jsx(SingleSelectOption, { value: "svg", children: "SVG" }),
            /* @__PURE__ */ jsx(SingleSelectOption, { value: "png", children: "PNG" }),
            /* @__PURE__ */ jsx(SingleSelectOption, { value: "jpeg", children: "JPEG" })
          ]
        }
      ),
      /* @__PURE__ */ jsx("span", { style: { height: "16px", display: "block" } }),
      format == "jpeg" && /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx(Field.Label, { children: "Quality" }),
        /* @__PURE__ */ jsx(Typography, { variant: "pi", textColor: "neutral600", children: "0.0 - 1.0" }),
        /* @__PURE__ */ jsx(
          NumberInput,
          {
            name: "quality",
    ...
    /* @__PURE__ */ jsx(Modal.Footer, { children: /* @__PURE__ */ jsx(
      Button,
      {
        ...
        startIcon: isExporting ? /* @__PURE__ */ jsx(Loader, { small: true }) : void 0,
...
const HomePage = React__default.memo(() => {
  const theme = useTheme();
  ...
  return /* @__PURE__ */ jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100vh" }, children: [
    /* @__PURE__ */ jsx(
      Layouts.Header,
      {
        title: "Schema Visualizer",
        primaryAction: /* @__PURE__ */ jsxs(Modal.Root, { children: [
          ...
          /* @__PURE__ */ jsx(ExportModal, { imageRef: ref2 })
        ] }),
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxs(
          ReactFlow,
          {
            ...flowProps,
            children: [
              /* @__PURE__ */ jsxs(Panel, { position: "top-right", style: { display: "flex", gap: "10px" }, children: [
                /* @__PURE__ */ jsx(
                  Button,
                  {
                    onClick: () => onLayout("TB"),
                ...
                Controls,
                {
                  ...
                  children: /* @__PURE__ */ jsx(
                    ControlButton,
                    {
                      ...
                      children: options.scrollMode ? /* @__PURE__ */ jsx(Drag, { fill: "#000000" }) : /* @__PURE__ */ jsx(Search, { fill: "#000000" })
                    }
                  )
                }
              ),
