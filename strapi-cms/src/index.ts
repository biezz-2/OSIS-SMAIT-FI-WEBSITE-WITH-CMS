...
async function ensureDefaultMediaAssets(strapi: Core.Strapi) {
  ...
  const defaultMediaAssets = [
    ...
    { key: 'edufest-ticker-gallery', judul: 'Galeri Ticker Edufest Infinity', kategori: 'ticker', tipe_media: 'foto', deskripsi: 'Kumpulan foto galeri berjalan Edufest Infinity dalam satu entri terpusat', urutan: 1 },
