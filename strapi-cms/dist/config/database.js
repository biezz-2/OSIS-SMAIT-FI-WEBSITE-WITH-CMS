...
function isPortOpen(host, port) {
    try {
        ...
        (0, child_process_1.execSync)(`"${process.execPath}" -e "${code}"`, { stdio: 'ignore', timeout: 1500 });
        return true;
    }
    catch (e) {
...
const config = ({ env }) => {
    ...
    const connections = {
        ...
        sqlite: {
            client: 'sqlite',
            connection: {
                filename: path_1.default.resolve(env('DATABASE_FILENAME') || 'C:/Users/attab/.gemini/antigravity/strapi_data.db'),
            },
